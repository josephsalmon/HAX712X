...
## Classes (to be investigated more later on)
 ...
 - Class: a structure that represents an object, its properties, and all the operations one can apply to it.
...
About `__call__`: `MyClass(arg1, arg2, ...)` is a shorthand for `MyClass.__call__(arg1, arg2, ...)`, so this allows to write classes where the instances behave like functions and can be called like a function
