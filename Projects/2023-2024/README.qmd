...
### Motivation
The main objective of this project is to create a simple website providing the weather forecast (in Montpellier) for the following 5 days. The data to be used for your project is to be obtained from [open-meteo.com](https://open-meteo.com/en/docs/meteofrance-api).
