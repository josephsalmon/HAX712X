...
2. A long term main group project (duration 2.5 months)
1. A side personal project: Weaher Forcast app (duration 1.5 months)
...
- a GitHub web page displaying images representing the **weather forcast for the 5 next days** that automatically updates. The website URL should be accessible in the README.md at the root of  your Git repositoary.
- a short description of the methodology used, below the forecast itself.

Please provide this URL in the following survey [https://framaforms.org/hax712x-depot-git-personnel-1693995810](https://framaforms.org/hax712x-depot-git-personnel-1693995810).


## Guidelines

- For this project, you need to create a **GitHub repository** with your code, and we suggest to use github action for the deployment phase (weather forcast update and website generation).
...
- Image format should be SVG only. See examples from [freesvg.org](https://freesvg.org/),
...
# Team project: air pollution data analysis

## Setting and objectives

The **group composition** are available on [Moodle](https://moodle.umontpellier.fr/course/view.php?id=22454).
...
- **Mid-term** project snapshot: Due date  **November 15, 23:59**. This will include the creation of a GitHub repository (`README.md`, `.gitignore` and an advance structure of the project code, etc.), a short description of how the work is shared in the team and a detailed work program for the project including the tasks' attribution (coding).

- **Preliminary presentation**: An oral presentation with `Quarto` (duration: 5mn), in-person on date/place TBC (December 2, 11:30 to 13:00).

- Due date (final project): The GitHub repository should be completed before **Tuesday 6 December (23:59)**. Nothing pushed after the deadline will be taken into account. The oral presentation (max: 20mn) will be in-person **Friday 9 December (8:00AM)** (room: TBD).
...
|     |Task affectation|1
|     |Dataset creation|1               |
|**Preliminary-term**|Slides (structure, spelling)|  0.5           |
...
The latter will be a short presentation of the work that will be orally presented during 15mn in front of a jury.
