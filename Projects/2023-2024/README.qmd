...
```{mermaid}
    gantt
        ...
        section Personal project 
            Weather Forecast App    :active,                2023-09-22, 2023-11-16
            Evaluation              :active, EVAL           2023-11-16, 2023-11-20
        section Team project 
            Research & Outlining    :active, OUTLINE,       2023-09-29, 2023-10-16
            Midterm evaluation      :active, MIDTERMEVAL    after OUTLINE, 2d
            Development             :active,                after MIDTERMEVAL, 2023-12-22
```
...
- **The GitHub repository** with the **presentations slides** should be completed before **Tuesday 6 December (23:59)**. Nothing pushed after the deadline will be taken into account. 

- The oral presentation (15mn + 5mn questions)  **December 11 (8:00)** (room: TBD).

### Mid-term project snapshot {#sec-midterm}

TODO: Create framapad

The main point for this step is to create a `README.qmd` (maximum length approximately 4 pages) in a `roadmap` directory at the root of your projet. We will provide you feedback in the form of *GitHub issues* on your project repository. Your file should give the outline of the project with the following ingredients:
...
- At least one of the page should contain an interactive element (maps, widget, etc.)
...
- Your repository should contains a `README.md`:
  - containing the title and a short description of the project
  - the link to the website
  - a code snippet to build the website
  - authors list and a licence description. See [this website](https://opensource.org/licenses/). A default choice could be MIT Licence.

#### Object programming aspects

- You should code at least one `Python` class.

- Your python project should contains submodules. Each submodule will be devoted to specific sub-task of your project.
...
- Docstrings should be populate at every python class and function
