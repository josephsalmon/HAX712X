...
<!---------------------------------------------------------------------------->
###  {{< iconify mdi:megaphone flip=horizontal  size=large >}} Crédits  {{< iconify mdi:megaphone  size=large >}}  {.large-header}
...
- [Hannah Fry](https://www.youtube.com/watch?v=Rzhpf1Ai7Z4): excellente oratrice (mathématiques appliquées)
...
::: {.column align="center" style='display: flex; justify-content: center; align-items: center;'}
![](images/plantnet-logo-title.26755cd.svg){width=74%}
:::
...
::: {.column width="45%"}
![](images/map_plantnet.png){width=90%}
:::
...
<img src="images/plantnet_usage_rasterized.svg" width="80%" align="middle" >
...
![](images/schema_plantnet_aggregation_js_0.svg){.fragment width=75% fragment-index=1}

![](images/schema_plantnet_aggregation_js_1.svg){.fragment width=75% fragment-index=2}

![](images/schema_plantnet_aggregation_js.svg){.fragment width=75% fragment-index=3}
:::
