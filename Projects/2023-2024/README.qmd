...
<u>Motivation</u>: The main objective of this project is to create a simple website providing the weather forecast (in Montpellier) for the following 5 days. The data to consider can be obtained here
...
and then provide the URL here in the following survey
[https://framaforms.org/hax712x-depot-git-personnel-1693995810](https://framaforms.org/hax712x-depot-git-personnel-1693995810).

You have to create a simple webpage using `Quarto` that can  automatically update the weather forecast, to display for instance something like this:
...
An example to help you in this task is available [here](https://josephsalmon.github.io/Tweets/economics/index.html). You can find the [associated source code](https://github.com/josephsalmon/Tweets/blob/master/economics/index.qmd).
This result is obtained using a GitHub page with a GitHub action with `Quarto`; see [https://quarto.org/docs/publishing/github-pages.html](https://quarto.org/docs/publishing/github-pages.html).
The associated `yml` used is available [here](https://github.com/josephsalmon/Tweets/blob/master/.github/workflows/publish.yml).
...
Moreover, you will write a short descrpition to explain your methodology
...
[openclipart](https://openclipart.org/), etc.) along with the highest/lowest temperature for the day, wind average, and amount of precipitation.
