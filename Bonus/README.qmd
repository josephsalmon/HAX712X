...
- Fork: Connect to your GitHub account (see [Git course](../Courses/Git/tp.qmd) for details) and fork the current repository by clicking on the "Fork" icon (note that HMMA238 was the old name of this course):
![plot](fork.png)
