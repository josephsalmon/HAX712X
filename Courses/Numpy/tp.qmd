...
## Broadcasting
Broadcasting allows to add matrices of different shapes, by repeating the smaller one along the missing dimensions. The only requirement is that the trailing dimensions match, somehow.
<table>
  <thead>
    <tr>
      <th>M</th>
