...
Shiny helps you to customize the layout and style of your application and dynamically respond to events, such as a button press, or dropdown selection.
It can then be interfaced easily with Quarto to render the app on your website, using a `{shinylive-python}` cell; see an example at <https://quarto-ext.github.io/shinylive/>.
