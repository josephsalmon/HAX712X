...
|----------|------|------------------------------------------------------------------------------------------------------|
|13/09/2024|BC    |[Command-line tools](Courses/Bash/tp.qmd)                                                             |
|17/09/2024|BC    |[Version control with Git](Courses/Git/tp.qmd)                                                        |
|27/09/2024|BC    |[IDE](Courses/IDE/tp.qmd) / [Python virtual environment](Courses/Venv/tp.qmd)                         |
|04/10/2024|JS |[Creating a Python Module](Courses/Python-modules/tp.qmd), [Classes & Exceptions](Courses/ClassesExceptions/tp.qmd)|
|11/10/2024|JS    |[Markdown to html (Quarto)](Courses/Docs/tp.qmd), [Unit Tests](Courses/Test/tp.qmd)|
|18/10/2024|JS    |[Pandas: Titanic dataset](Courses/Pandas/pandas_titanic.qmd), [Pandas: Airparif dataset](Courses/Pandas/pandas_airparif.qmd), [Pandas: Bikes dataset](Courses/Pandas/pandas_titanic.qmd)|
|25/10/2024|JS    |[Continuous Integration (CI)](Courses/CI/tp.qmd), [Generating a documentation (Sphinx)](Courses/Docs/tp.qmd), [Deploy on PyPI](Courses/Python-modules/tp.qmd)|
|08/11/2024|JS    |[SciPy](Courses/ScipyNumpy/tp.qmd)                                                                    |
|15/11/2024|JS    |[Debugging & Profiling](Courses/ProfilingDebugging/tp.qmd)                                                 |
|29/11/2024|JS    |[Sparse matrices, graphs and maps](Courses/TimeMemory/tp.qmd)                                                                   |
|06/12/2024|JS    |[Sparse matrices, graphs and maps](Courses/TimeMemory/tp.qmd)                                                                   |
...
Please carefully read the [projects description page](Projects/2024-2025/README.qmd).
...
*  (Scientific computing tools for Python) [Scipy lectures notes](https://scipy-lectures.org/intro/)
*  (Datasets) [Open Climate Data](http://openclimatedata.net/)
*  (Development in Scientific Python) [Scientific Python](https://learn.scientific-python.org/)
