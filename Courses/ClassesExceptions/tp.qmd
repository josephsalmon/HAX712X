...
```
:::
In particular, you can already discover all the attributes and methods share to all classes (*e.g.,* `__class__`, `__init__`,
 `__doc__`,), and the specific to that one (*e.g.,* `fit`, `get_params`, `predict`, etc.).
