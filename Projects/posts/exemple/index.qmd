...
<!-------------------------------------------------------------------------- -->
###  {{< iconify mdi:megaphone flip=horizontal >}} Credit  {{< iconify mdi:megaphone >}} {.large-header}
...
![](images/step1.svg){width=70%}
</div>

### Étape 2: <br> Faire un plan des slides


<div style="text-align: center;">


![](images/step2.svg){width=70%}
</div>


### Étape 3: <br> Créer des slides claires et concises


<div style="text-align: center;">


![](images/step3.svg){width=70%}
</div>
...
1. Créez un plan :
    ...
    **Objectif** : ne pas oublier de détails importants

2. Introduction (difficile):  perspective large / prépare l'audience à ce qui suivra
   - Utiliser une **image/video** pour capter l'attention

3. Méthodes :  Décrire les méthodes utilisées (crédibilité)
        - Utiliser des visuels pour décrire les méthodes
        - Inclure assez de détails pour que l'audience comprenne (éviter le superflu)

4. Résultats : Présenter les preuves soutenant votre travail
      - Choisir les résultats les plus importants et intéressants
      - Décomposer les résultats complexes en parties digestibles

5. Conclure sur le travail / les perspectives possibles
:::

. . .

**Conseil final** : Préparez introduction / conclusion solides, à mémorisez  pour éviter une début/fin maladroite
