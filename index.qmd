...
1. BC : (09/09/2022) [Linux essentials/command line tools: regexp, grep, find, rename](Courses/Bash/tp.qmd)

2. BC : (16/09/2022) [IDE: VScode](Courses/IDE/), [Python virtual env: Anaconda](Courses/Venv/tp.qmd), [Python virtual environment](Courses/Venv/tp.qmd), terminal, etc.

3. BC : (23/09/2022) [Git: a first introduction, `github`, ssh key creation, various git commands, conflict, pull request](Courses/Git/tp.qmd); see also [Bonus/](Bonus/README.md), [hands on git](Courses/Git/tp.qmd)

4. BC (quiz 1) + JS : (30/09/2022) [Create a Python Module](Courses/Python-modules/tp.qmd), [classes (`__init__`, `__call__`, etc...), operator overloading, files handling](Courses/Classes_n_Exceptions/tp.qmd),

5. JS : (03/10/2022 + 07/10/2022)  [unit tests](Courses/Test/tp.qmd)

6. JS : (10/10/2022 + 14/10/2022)  [Pandas: first steps / missing data](Courses/Pandas/tp.qmd)

7. JS : (17/10/2022 + 21/10/2022) [`scipy, numpy`: Images/channel](Courses/ScipyNumpy/tp.qmd)

8. JS (quiz 2) : (28/10/2022) [Sparse matrices,](Courses/TimeMemory/tp.qmd) [graphs and memory](Courses/TimeMemory/tp.qmd)

9. BC : (18/11/2022) [Documentation with Sphinx](Courses/Docs/tp.qmd) and  [Continuous Integration (CI)](Courses/CI/tp.qmd)
...
Short quiz of 20 min each (on Moodle). This will be personal work.
