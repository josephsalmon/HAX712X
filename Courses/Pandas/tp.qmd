...
Contrarily to *numpy* arrays, you can index with other thing than integers:
...
```
Comments: not all passengers from Cherbourg are Gaulois...
...
# `seaborn` visualization with `pandas`:
```python
...
### <font color='red'> EXERCISE: Is the helmet saving your life?
