...
### <font color='red'>Exercise</font>
   ...
   3. Got to `/var/log/` and list every file with a double extension: the former one is a dot followed by a number, and the last one is `.log` (e.g. `Xorg.3.log` or  `Xorg.0.log`)
