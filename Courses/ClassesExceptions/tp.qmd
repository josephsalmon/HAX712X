...
```
Test function of interest: `isinstance` allows to check if an object is of the correct class, for instance
```{python}
...
Test if a class has inherited from another class: `issubclass` allow to check this heritage property:
