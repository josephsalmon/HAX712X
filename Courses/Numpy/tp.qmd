...
<table>
  ...
  <tbody>
        ...
        <tr>
            ...
            <td> <center><image src = "../ScipyNumpy/CheatSheet/figures/Operations-mean1.svg" width="66px"></image> </center> </td>
        </tr>
    </tbody>
</table>
...
## Broadcasting
Broadcasting allow to add matrices of different shapes, by repeating the smaller one along the missing dimensions. The only requirement is that the trailing dimensions match.
<table>
  <thead>
    <tr>
      <th>M</th>
