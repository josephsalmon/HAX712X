...
# sns.set_palette("twilight", n_colors=12)
palette = sns.color_palette("twilight", n_colors=12)

fig, axes = plt.subplots(2, 1, figsize=(7, 7), sharex=True)

axes[0].set_prop_cycle((cycler(color=palette) +
                  cycler(linestyle=['-', '--', ':', '-.']*3)))
...
axes[1].set_prop_cycle((cycler(color=palette) +
                  cycler(linestyle=['-', '--', ':', '-.']*3)))
...
df_bikes.head()
# sns.set_palette("twilight", n_colors=12)  # sns.set_palette("colorblind",...)
palette = sns.color_palette("twilight", n_colors=12)
...
axes.set_prop_cycle((cycler(color=palette) +
                  cycler(linestyle=['-', '--', ':', '-.']*3))) # gca()
