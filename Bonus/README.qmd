...
## Pull Request (PR)
The pull request system is a standard way of proposing improvements and modifications in open-source project. Here we use it for the opportunity to improve the course material.

The principle is the following

- Fork: Connect to your Github account (see [Git lecture](../Courses/Git/tp.qmd) for details) and fork the current repository by clicking on the "Fork" icon (note that HMMA238 was the old name of this course):
![plot](fork.png)

- Go to your Github account and find the HAX712X repository. In what follows you should substitute `my_github_id` by your github identification; in the screenshots, the examples are with **my_github_id=josephsalmon** and they should be adapted according to yours.
