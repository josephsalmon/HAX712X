...
**Disclaimer**: this course is adapted from the following works
...
you should reach 79% of code coverage, and the report should look like this (see the `htmlcov/index.html` file for details and interactive report):
