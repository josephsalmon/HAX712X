...
```
**References**:
- [Github docs](https://help.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) on connecting with SSH.

### Windows

**References**:
- [The Server Side](https://www.theserverside.com/blog/Coffee-Talk-Java-News-Stories-and-Opinions/GitHub-SSH-Windows-Example): How to SSH into GitHub on Windows example, by Cameron McKenzie
