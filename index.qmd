...
5. 13/10/2023 (JS): [unit tests](Courses/Test/tp.qmd)

6. 20/10/2023 (JS): [Pandas: first steps / missing data](Courses/Pandas/tp.qmd)

7. 27/10/2023 (BC): [Documentation with Sphinx](Courses/Docs/tp.qmd) and  [Continuous Integration (CI)](Courses/CI/tp.qmd)

8. 10/11/2023 (JS): [`scipy, numpy`: Images/channel](Courses/ScipyNumpy/tp.qmd)

9. 17/11/2023 (JS): [Sparse matrices,](Courses/TimeMemory/tp.qmd) 

10. 20/11/2023 (JS): [graphs and memory](Courses/TimeMemory/tp.qmd)

11. 15/12/2022 (BC + JS) The end:  Project presentations


## Grading

For this course, the grading consists in two projects: one group project (group composition available on [moodle](https://moodle.umontpellier.fr/course/view.php?id=22454)) and a personal one.
