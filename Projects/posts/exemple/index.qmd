...
**Conseil final** : Préparez introduction / conclusion comme dans un bon film (de S. Kubrick par exemple), à mémorisez pour éviter une début/fin maladroite
...
2. **Conception des diapositives** :
    - Choisir le type: Quarto, Beamer, Impress
...
2. **Éléments textuels** :
    - Texte concis : Éviter phrases complètes, jamais plus de 12 lignes par diapositive
...
4. **Animations & transitions** : éviter les distractions, transitions entre sections (change de sujet)
