...
We create a branch, where we make all the commits dedicated to solvings the bug. The idea is to maintain a stable version, in the branch `master`, separated from the developing version, which may contain bugs.
