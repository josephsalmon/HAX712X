...
*magic* commands are commands such as: %timeit, %matplotlib, %autoreload;
see for instance
...
For VScode: see for instance <https://www.youtube.com/watch?v=w8QHoVam1-I>s.
