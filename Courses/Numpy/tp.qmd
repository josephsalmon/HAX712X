...
<table>
  ...
  <tbody>
        <tr>
            ...
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-zeros-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre> M = np.ones((5, 9))</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-ones-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            ...
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-list-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre> M = np.arange(45).reshape((5, 9))</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-arange-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre> M = rng.random((5, 9))</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-uniform-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre> M = np.eye(5, 9)</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-eye-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre> M = np.diag(np.arange(5))</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-diag-2.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre> M = np.diag(np.arange(3), k=2)</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/create-diagk-2.svg" width="200px"></image> </td>
        </tr>
    </tbody>
</table>
...
<table>
  ...
  <tbody>
        <tr>
            ...
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/reshape-M-reshape(4,3).svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre>M = M.reshape(12, 1)</pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/reshape-M-reshape(12,1).svg" width="200px"></image> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/reshape-M-reshape(6,2).svg" width="200px"></image> </td>
        </tr>
        <tr>
...
Start from a simple matrix matrix:
```Python
rows, cols = 3, 6
...
<table>
  ...
  <tbody>
        <tr>
            ...
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/Operations-where.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre>np.maximum(M, 0.5) </pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/Operations-max.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre>np.minimum(M, 0.5) </pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/Operations-min.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre>np.mean(M, axis=0) </pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/Operations-mean0.svg" width="200px"></image> </td>
        </tr>
        <tr>
            <td> <pre>np.mean(M, axis=1) </pre> </td>
            <td> <image src = "../ScipyNumpy/CheatSheet/figures/Operations-mean1.svg" width="200px"></image> </td>
        </tr>
    </tbody>
</table>
...
For the last opertations note that the dimension of the matrices are reduced, so you create a vector as a result, with dimention `(6,)` or `(3,)` respectively, when computing the mean along the 0-axis (column-wise mean), respectively along the 1-axis (row-wise mean).
:::
