...
N.B.: it is possible to create references to labels linked to an image, a section, in the `.rst` file etc...
...
Sphinx-Gallery is an extension able to create galleries of examples in the `html` documentation directly from the script files of your project. See e.g., <https://sphinx-gallery.github.io/stable/auto_examples/index.html>
...
**Warning:** With default options, Sphinx-Gallery only executes the script files with a filename starting by `plot_`.
